...
class Page5(customtkinter.CTkFrame):
    def __init__(self, parent, controller):
        ...
        global preview
        preview = customtkinter.CTkLabel(master=monitor,text="", fg_color="#262626")
        ...
        nextButton = customtkinter.CTkButton(master=self, width=150, height=50, text="Next", font=("Tahoma", 15, "bold"), corner_radius=1, border_width=1, border_color="#4CC9F0", fg_color="#262626", hover_color="#4CC9F0", command=lambda: controller.show_frame("Page1"))
